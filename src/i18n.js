...
const translations = {
  ...
  'settings.version': { en: 'Pocket Khata', bn: 'পকেট খাতা' },
  ...
  'budget.showBreakdown': { en: 'Show details', bn: 'বিস্তারিত দেখুন' },
  'budget.hideBreakdown': { en: 'Hide details', bn: 'বিস্তারিত লুকান' },
  'budget.noSubcategories': { en: 'No subcategories tracked this month', bn: 'এই মাসে কোনো উপ-ক্যাটাগরি ট্র্যাক করা হয়নি' },
  ...
  'reminders.billNamePlaceholder': { en: 'E.g., Dhaka Electric Supply, Spotify', bn: 'যেমন, ঢাকা ইলেকট্রিক, স্পটিফাই' },
  ...
  'reminders.postExpense': { en: 'Post expense of', bn: 'ব্যয় পোস্ট করুন' },
  'reminders.expenseFor': { en: 'for', bn: 'এর জন্য' },
  'reminders.from': { en: 'from', bn: 'হতে' },
  ...
  'reminders.errDate': { en: 'Please select a due date.', bn: 'অনুগ্রহ করে পরিশোধের তারিখ নির্বাচন করুন।' },
  ...
  'notif.reminderAlerts': { en: 'Reminder Alerts', bn: 'রিমাইন্ডার সতর্কতা' },
  'notif.reminderAlertsDesc': { en: 'Receive alerts for due reminders', bn: 'নির্ধারিত রিমাইন্ডারের জন্য সতর্কতা পান' },
  'notif.dueToday': { en: '{name}: ৳{amount} — due today', bn: '{name}: ৳{amount} — আজকে পরিশোধ' },
