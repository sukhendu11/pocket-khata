...
const translations = {
  ...
  // [REMINDERS] Bill reminder i18n keys — kept for future implementation
  ...
  // 'reminders.addReminder': { en: 'Add Reminder', bn: 'রিমাইন্ডার যোগ করুন' },
  // 'reminders.editReminder': { en: 'Edit Reminder', bn: 'রিমাইন্ডার সম্পাদনা' },
  // 'reminders.deleteReminder': { en: 'Delete Reminder', bn: 'রিমাইন্ডার মুছুন' },
  // 'reminders.markPaid': { en: 'Mark as Paid', bn: 'পরিশোধিত হিসাবে চিহ্নিত করুন' },
  // 'reminders.dueDate': { en: 'Due Date', bn: 'নির্ধারিত তারিখ' },
  // 'reminders.amount': { en: 'Amount', bn: 'পরিমাণ' },
  // 'reminders.recurring': { en: 'Recurring', bn: 'পুনরাবৃত্ত' },
  // 'reminders.overdue': { en: 'Overdue', bn: 'মেয়াদোত্তীর্ণ' },
  // 'reminders.overdueReminders': { en: 'Overdue Reminders', bn: 'মেয়াদোত্তীর্ণ রিমাইন্ডার' },
  // 'reminders.payReminder': { en: 'Pay Now', bn: 'এখন পরিশোধ করুন' },
  // 'reminders.noOverdue': { en: 'No overdue reminders', bn: 'কোনো মেয়াদোত্তীর্ণ রিমাইন্ডার নেই' },
  // 'reminders.upcoming': { en: 'Upcoming', bn: 'আসন্ন' },
  // 'reminders.paid': { en: 'Paid', bn: 'পরিশোধিত' },
  // 'reminders.unpaid': { en: 'Unpaid', bn: 'অপরিশোধিত' },
  // 'reminders.allReminders': { en: 'All Reminders', bn: 'সকল রিমাইন্ডার' },
  // 'reminders.reminderSaved': { en: 'Reminder saved successfully', bn: 'রিমাইন্ডার সফলভাবে সংরক্ষিত' },
  // 'reminders.reminderDeleted': { en: 'Reminder deleted', bn: 'রিমাইন্ডার মুছে ফেলা হয়েছে' },
  // 'reminders.reminderPaid': { en: 'Reminder marked as paid', bn: 'রিমাইন্ডার পরিশোধিত হিসেবে চিহ্নিত' },
  // 'notif.title': { en: 'Notifications', bn: 'নোটিফিকেশন' },
  // 'notif.notificationSettings': { en: 'Notification Settings', bn: 'নোটিফিকেশন সেটিংস' },
  // 'notif.notificationDesc': { en: 'Get notified about upcoming and overdue bill reminders.', bn: 'আসন্ন এবং মেয়াদোত্তীর্ণ বিল রিমাইন্ডার সম্পর্কে নোটিফিকেশন পান।' },
  // 'notif.permission': { en: 'Notification Permission', bn: 'নোটিফিকেশন অনুমতি' },
  // 'notif.granted': { en: 'Granted ✓', bn: 'অনুমতি দেওয়া হয়েছে ✓' },
  // 'notif.denied': { en: 'Denied ✗', bn: 'অনুমতি দেওয়া হয়নি ✗' },
  // 'notif.requestPermission': { en: 'Request Permission', bn: 'অনুমতি চান' },
  // 'notif.testNotification': { en: 'Send Test Notification', bn: 'পরীক্ষামূলক নোটিফিকেশন পাঠান' },
  // 'notif.scheduleReminder': { en: 'Schedule Bill Reminder', bn: 'বিল রিমাইন্ডার নির্ধারণ' },
  // 'notif.reminderScheduled': { en: 'Bill reminder notification scheduled', bn: 'বিল রিমাইন্ডার নোটিফিকেশন নির্ধারিত' },
  // 'notif.checkReminders': { en: 'Check Reminders', bn: 'রিমাইন্ডার চেক করুন' },
  // 'notif.daysOverdue': { en: '{days} day(s) overdue', bn: '{days} দিন মেয়াদোত্তীর্ণ' },
  // 'notif.payReminderNotice': { en: 'Reminder: {title} of ৳{amount} is overdue by {days} day(s)', bn: 'রিমাইন্ডার: {title} এর ৳{amount} {days} দিন মেয়াদোত্তীর্ণ' },
