/*
  🔔 Notification Utility — Commented out for future use
  ==============================================================================

  This module was removed from active use in commit 00659e4 but is preserved
  here as a reference. To re-enable:
    1. Uncomment this entire file
    2. Restore the ReminderManager component
    3. Restore the i18n keys (notif.*)
    4. Re-add the imports in App.jsx and main.jsx
    5. Re-add the notification code in public/sw.js
==============================================================================
*/
