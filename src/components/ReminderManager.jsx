/*
  🗓️ Bill Reminder Manager — Commented out for future use
  ==============================================================================

  This component was removed from active use in commit 00659e4 but is preserved
  here as a reference. To re-enable:
    1. Uncomment this entire file
    2. Restore the notifications.js module
    3. Restore the i18n keys (reminders.*, notif.*)
    4. Restore the db methods (getReminders, saveReminders, addReminder, etc.)
    5. Re-add the lazy import and ReminderManager route in App.jsx
    6. Re-add the reminders state/props/handlers in App.jsx
    7. Re-add the notification card in Settings.jsx
    8. Re-add the Bell icon and overdue badge in Dashboard.jsx
    9. Re-add the notification calls in main.jsx
    10. Re-add the notification code in public/sw.js
==============================================================================
*/
