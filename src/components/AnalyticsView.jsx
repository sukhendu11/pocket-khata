...
import { ArrowLeft, TrendingUp, TrendingDown, AlertTriangle, Target, Lightbulb, Home } from 'lucide-react';
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <button
          ...
          onClick={() => { onNavigate('dashboard'); trackAction('home_nav', { source: 'analytics' }); }}
        >
          <Home size={18} />
        </button>
      </div>
