...
describe.skip('notifications — preserved for future use', () => {
...
/*
  🔔 Notification Utility Tests — Commented out for future use
  ==============================================================================

  This test file was removed alongside the notification module in commit 00659e4.
  To re-enable:
    1. Uncomment this entire file
    2. Restore src/notifications.js (also commented out)
    3. Run tests
==============================================================================
*/
